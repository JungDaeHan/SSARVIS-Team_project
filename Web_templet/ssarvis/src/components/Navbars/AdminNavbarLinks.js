...
import { NavLink } from "react-router-dom"; // 0803 kihun
...
export default function AdminNavbarLinks() {
  ...
  const handleCloseProfile = (name) => (event) => {
    if (name === "logout") {
        ...
        >
          ...
          <Hidden mdUp implementation="css">
            <p className={classes.linkText}>
              {user.user_state === "Logout" ? "로그인" : "로그아웃"}
            </p>
          </Hidden>
        </Button>
        <Poppers
            ...
            >
              <Paper>
                <ClickAwayListener onClickAway={handleCloseProfile}>
                  {user.user_state === "Logout" || user.user_name === "" ? (
                    <MenuList role="menu">
