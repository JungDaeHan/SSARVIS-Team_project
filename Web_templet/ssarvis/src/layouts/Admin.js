...
export default function Admin({ ...rest }) {
  ...
  const { user, sideberOpen } = useContext(CommonContext);

  const ChangelayoutWidth = () => {
    if (sideberOpen) return classes.mainPanel;
    else return classes.test;
  };
  ...
  return (
    <div className={classes.wrapper}>
      ...
      <div
        className={clsx({
          [classes.mainPanel]: sideberOpen,
          [classes.test]: !sideberOpen,
        })}
        ref={mainPanel}
      >
        <Navbar
